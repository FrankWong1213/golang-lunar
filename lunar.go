...
var chineseNumber []string = []string{"一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二"}
var lunarInfo []int = []int{0x04bd8, 0x04ae0, 0x0a570,
...
var gan []string = []string{"甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "壬", "癸"}
var zhi []string = []string{"子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌", "亥"}
var chineseTen []string = []string{"初", "十", "廿", "卅"}
var animals []string = []string{"鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗", "猪"}
var year, month, day int
var leap bool
var TimeFormat string = "2006-01-02 15:04:05"
var TimeFormat1 string = "20060102"

//输入日期格式为YYYYMMDD
func Lunar(date string) string {
	var monCyl, leapMonth int = 0, 0
	t1, _ := time.Parse(TimeFormat, "1900-01-31 00:00:00")
	t2, err := time.Parse(TimeFormat1, date)
	if err != nil {
